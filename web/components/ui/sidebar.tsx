  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-gray-200 text-sidebar-foreground flex h-full w-64 flex-col",
          className,
        )}
        {...props}
      >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-gray-200 text-sidebar-foreground w-full p-0 [&>button]:hidden"
          side={side}
        >
    ...
    >
      ...
      >
        <div
          ...
          className="bg-gray-200 group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
